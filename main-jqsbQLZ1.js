      ...
      children: [
        {
          path: "/",
          name: "Home",
          component: () => import("./HomeView-HUFRsT99.js")
        },
        {
          path: "/main-view",
          name: "HomePage",
        ...
        },
        {
          path: "/location",
          name: "LocationPage",
          component: () => import("./LocationView-EeTmcka6.js")
        },
        {
          path: "/compare",
          name: "ComparePage",
          component: () => import("./CompareView-FKHy1cPF.js")
        },
        {
          path: "/gallery",
          name: "GalleryPage",
          component: () => import("./GalleryView-o2GN0S-j.js")
        }
      ]
    }
  ]
...
function ag(t) {
  const e = Os(ad), n = ld();
  e.use(xh), e.use(n), e.config.globalProperties.$store = n, e.config.globalProperties.$axios = Qp, e.use(og, {
    load: {
...
const cg = "production";
console.log("Environment Mode:", cg);
window.mountWidget = ag;
export {
  Jt as _,
  df as c,
  hf as g,
